...
from TA_schedule.instructor import Instructor
...
class TestInit(unittest.TestCase):
    ...
    def test_instr_oh(self):
        self.assertEqual(self.instr2.meetTime, self.dt)
